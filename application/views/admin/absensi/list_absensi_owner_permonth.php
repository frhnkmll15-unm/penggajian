          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <?php echo form_open("absensi/cari_absen_owner"); ?>
                     <div class="box-header">
                  <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                    ...
                    <a href="<?php echo base_url('absensi/cetak_absensi_range_owner/'.$t1.'/'.$t2.''); ?>" class="btn btn-warning" target="_blank"><i class="fa fa-print"></i> Cetak</a>
                    <?php } ?>
