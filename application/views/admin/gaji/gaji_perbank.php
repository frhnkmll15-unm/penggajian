            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data gaji Perbank</h3> 
                 
                </div><!-- /.box-header -->
                <?php echo form_open("gaji/cari_gaji_perbank"); ?>
                     <div class="box-header">
                  <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                    ...
                    <a href="<?php echo base_url('gaji/cetak_gaji_bank_range/'.$t1.'/'.$t2.''); ?>" class="btn btn-warning" target="_blank"><i class="fa fa-print"></i> Cetak</a>
                    <?php } ?>
                    <a href="<?php echo base_url('gaji/cetak_gaji_bank_semua'); ?>" class="btn btn-danger" target="_blank"><i class="fa fa-print"></i> Cetak Semua</a>
                  </div> 
                </div><!-- /.box-header -->
                <div class="box-body">
