<section class="content-header">
        ...
        <section class="content">
          ...
          <?php echo form_open_multipart("pinjaman/edit_submit"); ?>
          <?php
          foreach ($data as $d) {
            ?>
       ...
       <br>
        ...
        <div class="row">
          <div class="form-group">
            ...
            <div class="col-lg-6 ">
              <input type="text" name="pinjaman" class="form-control" maxlength="100" placeholder="Pinjaman" value="<?php echo $d->pinjaman; ?>">
            </div>
          </div>
        </div>
        <br>
        <div class="row">
          <div class="form-group">
            ...
            <div class="col-lg-6 ">
              <input type="text" name="tgl_pinjaman" class="form-control" maxlength="100" placeholder="Tanggal Pinjaman" id="datepicker2" value="<?php echo $d->tgl_peminjaman; ?>">
            </div>
          </div>
        </div>
        <br>
